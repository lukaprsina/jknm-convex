/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: f493b1561ed6cb13166d2ecb9a0b9f00)
...
declare namespace Cloudflare {
	interface Env {
		...
		JKNM_SERVICE_ACCOUNT_CREDENTIALS: string;
		JKNM_WORKSPACE_ID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "CONVEX_DEPLOY_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "JKNM_SERVICE_ACCOUNT_CREDENTIALS" | "JKNM_WORKSPACE_ID">> {}
}
