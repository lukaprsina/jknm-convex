...
export function PublishDialogue() {
	...
	const dialog_content_ref = useRef<HTMLDivElement>(null);
	...
	return (
		...
		>
			{/* sm:max-w-lg */}
			<DialogContent className="flex flex-col gap-0 p-0 sm:max-h-[min(640px,80vh)] sm:max-w-3xl [&>button:last-child]:hidden">
