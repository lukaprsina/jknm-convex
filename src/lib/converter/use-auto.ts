...
import { ConverterActions, ConverterState } from "~/routes/converter";

// Automated loop for processing articles
export function useAutoAccept({state, setState, actions}: {state?: ConverterState, setState?: React.Dispatch<React.SetStateAction<ConverterState>>, actions?: ConverterActions}) {
